...
from .ptfuitl import PointNetFeaturePropagation, PointNetSetAbstraction
...
class get_model(nn.Module):
    def __init__(self, num_point=1024, nblocks=4, nneighbor=16, num_class=8, input_dim=4):
        super().__init__()
        transformer_dim = 512
        self.backbone = Backbone(npoints=num_point, nblocks=nblocks, nneighbor=nneighbor,
                                    n_c=num_class,transformer_dim=transformer_dim,d_points= input_dim)
